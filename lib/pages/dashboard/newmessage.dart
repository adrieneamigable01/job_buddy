...
class NewChatMessagesPage extends StatefulWidget {
  // const NewChatMessagesPage({super.key});

  @override
  State<NewChatMessagesPage> createState() => _NewChatMessagesPageState();
}

class _NewChatMessagesPageState extends State<NewChatMessagesPage> {
  @override
    ...
    return Scaffold(
      ...
      body: OrientationLayoutBuilder(
        portrait: (context) => ScreenTypeLayout.builder(
          ...
          //   watch: 300,
          // ),
          mobile: (BuildContext context) => NewChatPage(),
