              ...
              return BlocBuilder<AppReviewCubit,AppReviewState>(
                builder: (context, state) {
                  ...
                  return AlertDialog(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              fillColor: isLoadingReviewState ? Colors.grey : null,
                            ),
                          ),
                        ],
                      ),
                    ...
                    actions: [
                      TextButton( 
                        onPressed: () => !isLoadingReviewState ? Navigator.pop(context): null,
                        child: Text('Cancel'),
                      ),
                      ElevatedButton(
                        onPressed: () {
                        ...
                        child: Text(isLoadingReviewState ? 'Loading..' :  'Submit'),
                      ),
                    ],
                  );
                },
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [Color(0xFFFDF0B1), Color(0xFFF9C920)],
                                ...
                                : Positioned(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        if (_userBox.data.validationStatus !=
                                            "Validated") {
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: Color(0xFFEDCDCD),
                                        padding: EdgeInsets.symmetric(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return NotificationCard(
                                  notification: NotificationBox().items[index]);
                            },
                          ),
                        )),
                    Visibility(
                                ...
                                Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        child: Text(
                                          _userBox.data.validationStatus !=
                                                  "Validated"
                                              ? 'Unverified'
                                              : _userBox.data.validationStatus
                                                  .toString(),
