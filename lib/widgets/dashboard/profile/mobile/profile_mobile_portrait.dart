...
class ProfileMobilePortrait extends StatefulWidget {
  ProfileMobilePortrait({super.key});

  @override
  State<ProfileMobilePortrait> createState() => _ProfileMobilePortraitState();
}

class _ProfileMobilePortraitState extends State<ProfileMobilePortrait> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow("Date of Birth",
                        "${_userBox.data.birthdate ?? ''}"),
                    SizedBox(height: 20), // Space between name and email
                    _buildInfoRow("Present School", 'Sample' ?? ''),
                    SizedBox(height: 20), // Space between name and email
                    _buildInfoRow(
                        "Phone Number",
                        _userBox.data.phone == ''
                            ? '+63 9-'
                            : _userBox.data.phone.toString()),
                    SizedBox(height: 20), // Space between name and email
                    _buildInfoRow("Address", _userBox.data.address ?? ''),
                    SizedBox(height: 20), // Space between name and email
                    _buildInfoRow("Password",' ******',
                      GestureDetector(
                        ...
                        child: Text("Change Password",style: TextStyle(color: Color(0xff0D99FF)),),
                      )
                    ),
                    SizedBox(height: 20), // Space between name and email
                    // GestureDetector(
